  ...
  new Vue({
    ...
    methods: {
      ...
      productImage: function (event) {
        ...
        var Image =
          event.target.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.querySelectorAll(
            ".img-second"
          )[0];
      ...
      changeImg: function (event) {
        ...
        var mainImg = document.querySelector(
          "#ModalQuickView .gallery .main-image"
        );
    ...
    mounted: function () {
      ...
      this.$root.$on("bv::modal::show", (bvEvent, modalId) => {
        if (modalId == "ModalQuickView") {
          if (
            document.querySelector("#ModalQuickView___BV_modal_outer_") !== null
          ) {
            document
              .querySelector("#ModalQuickView___BV_modal_outer_")
              .remove();
          }
        }
      });
...
function displayBarNotification(message, messagetype, timeout) {
  if (messagetype == "error") {
    toastHTML =
      '<b-toast id="grandToast" auto-hide-delay=' +
      timeout +
      ' variant="danger" title=' +
      messagetype +
      ">" +
      message +
      "</b-toast>";
...
function newsletter_subscribe(subscribe) {
  ...
  axios({
    ...
    .then(function (response) {
      ...
      document.querySelector("#newsletter-result-block .alert").innerHTML =
      ...
      if (response.data.Success) {
        ...
        if (
          document.querySelector(
            ".newsletter-inputs .newsletter-subscribe-unsubscribe"
          )
        ) {
          document.querySelector(
            ".newsletter-inputs .newsletter-subscribe-unsubscribe"
        ...
        document.querySelector("#newsletter-result-block").style.display =
          "block";
        document
          .getElementById("newsletter-result-block")
          .classList.add("success");
        document.getElementById("newsletter-result-block").style.bottom =
          "unset";
        ...
        window.setTimeout(function () {
          document.getElementById("newsletter-result-block").style.display =
            "none";
        }, 2000);
      }
    })
...
function newsletterBox() {
  if (document.getElementById("newsletter-subscribe-button")) {
    ...
    el.onclick = function () {
      var allowToUnsubscribe = document
        .getElementById("newsletterbox")
        .getAttribute("data-allowtounsubscribe")
        .toLowerCase();
...
function sendcontactusform(urladd) {
  if (document.querySelector("#ModalQuickView") == null) {
    if (
      document
        .querySelector(".product-standard #product-details-form")
        .checkValidity()
    ) {
      var bodyFormData = new FormData();
      bodyFormData.append(
        "AskQuestionEmail",
        document.querySelector(".product-standard #AskQuestionEmail").value
      );
      bodyFormData.append(
        "AskQuestionFullName",
        document.querySelector(".product-standard #AskQuestionFullName").value
      );
      bodyFormData.append(
        "AskQuestionPhone",
        document.querySelector(".product-standard #AskQuestionPhone").value
      );
      bodyFormData.append(
        "AskQuestionMessage",
        document.querySelector(".product-standard #AskQuestionMessage").value
      );
      bodyFormData.append(
        "Id",
        document.querySelector(".product-standard #AskQuestionProductId").value
      );
      bodyFormData.append(
        "__RequestVerificationToken",
        document.querySelector(
          ".product-standard input[name=__RequestVerificationToken]"
        ).value
      );
      if (
        document.querySelector(
          ".product-standard textarea[id^='g-recaptcha-response']"
        )
      ) {
        bodyFormData.append(
      ...
      axios({
        ...
        .then(function (response) {
          if (response.data.success) {
            document.querySelector(
              ".product-standard #contact-us-product"
            ).style.display = "none";
            document.querySelector(
              ".product-standard .product-contact-error"
            ).style.display = "none";
            document.querySelector(
              ".product-standard .product-contact-send"
    ...
    if (
      document
        .querySelector("#ModalQuickView #product-details-form")
        .checkValidity()
    ) {
      var bodyFormData = new FormData();
      bodyFormData.append(
        "AskQuestionEmail",
        document.querySelector("#ModalQuickView #AskQuestionEmail").value
      );
      bodyFormData.append(
        "AskQuestionFullName",
        document.querySelector("#ModalQuickView #AskQuestionFullName").value
      );
      bodyFormData.append(
        "AskQuestionPhone",
        document.querySelector("#ModalQuickView #AskQuestionPhone").value
      );
      bodyFormData.append(
        "AskQuestionMessage",
        document.querySelector("#ModalQuickView #AskQuestionMessage").value
      );
      bodyFormData.append(
        "Id",
        document.querySelector("#ModalQuickView #AskQuestionProductId").value
      );
      bodyFormData.append(
        "__RequestVerificationToken",
        document.querySelector(
          "#ModalQuickView input[name=__RequestVerificationToken]"
        ).value
      );
      if (
        document.querySelector(
          "#ModalQuickView textarea[id^='g-recaptcha-response']"
        )
      ) {
        bodyFormData.append(
          "g-recaptcha-response-value",
      ...
      axios({
        ...
        .then(function (response) {
          if (response.data.success) {
            document.querySelector(
              "#ModalQuickView #contact-us-product"
            ).style.display = "none";
            document.querySelector(
              "#ModalQuickView .product-contact-error"
            ).style.display = "none";
            document.querySelector(
              "#ModalQuickView .product-contact-send"
            ).innerHTML = response.data.message;
            document.querySelector(
              "#ModalQuickView .product-contact-send"
            ).style.display = "block";
...
function displayPopupNotification(message, messagetype) {
  ...
  if (typeof message == "string") {
    htmlcode =
      '<b-modal ref="grandModal" id="grandModal" centered hide-footer hide-header><b-alert class="mb-0" show>' +
      message +
      "</b-alert></b-modal>";

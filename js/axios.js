  ...
  addproducttocart_catalog: function (urladd, showqty, productid) {
    if (showqty.toLowerCase() == "true") {
      var qty = document.querySelector(
        "#addtocart_" + productid + "_EnteredQuantity"
      ).value;
  ...
  addproducttocart_details: function (urladd, formselector) {
    ...
    if (document.querySelector("#ModalQuickView")) {
      var form = document.querySelector(
        "#ModalQuickView #product-details-form"
      );
    } else {
      var form = document.querySelector(
        ".product-standard #product-details-form"
      );
    }
  ...
  success_process: function (response) {
    if (response.data.updatetopwishlistsectionhtml) {
      if (document.querySelector(".wishlist-qty"))
        document.querySelector(".wishlist-qty").innerHTML =
          response.data.updatetopwishlistsectionhtml;
    }
    ...
    if (response.data.message) {
      if (response.data.success == true) {
        ...
        if (response.data.refreshreservation == true) {
          ...
          Reservation.fillAvailableDates(
            Reservation.currentYear,
            Reservation.currentMonth,
            param,
            true
          );
        }
